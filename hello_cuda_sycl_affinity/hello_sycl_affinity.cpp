...
int main(int argc, char *argv[]) try {
    ...
    const char* cuda_visible_devices = getenv("ZE_AFFINITY_MASK");
    ...
    */
    ...
    for (int i = 0; i < num_devices; i++) {
        ...
        busid = dpct::get_device(i).get_info<sycl::ext::intel::info::device::pci_address>();
        snprintf(bus_id_str, sizeof(bus_id_str), "%s", busid.c_str());
